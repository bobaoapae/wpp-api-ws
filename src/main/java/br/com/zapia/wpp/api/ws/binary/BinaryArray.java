...
public record BinaryArray(byte[] data) {
     ...
     */
    public static BinaryArray of(String in) {
     ...
     */
    public static BinaryArray ofBase64(String input) {
    ...
    public int toInt() {
        if (size() > 4)
            throw new RuntimeException("Cannot convert BinaryArray to int, overflow: " + size());
        var value = 0;
